...
public class ArvoreBinaria<E> {
    ...
    private ArrayList<ArvoreBinaria<E>> fila = new ArrayList<ArvoreBinaria<E>>();
    private ListIterator<ArvoreBinaria<E>> iterador;
    ...
    public ArvoreBinaria<E> proximoEmNivel() {
        ...
        if (fila.isEmpty() && ultimoVisitado != null) {
            int i = 0;
            fila.add(ultimoVisitado);
            
            while (i < fila.size()) {
                ultimoVisitado = fila.get(i);
                if(ultimoVisitado.esquerda != null)
